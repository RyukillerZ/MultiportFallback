...
MYIP=$( curl -sS https://raw.githubusercontent.com/RyukillerZ/MultiportFallback/main/ACCESS/access | awk '{print $2}' )
Name=$(curl -sS https://raw.githubusercontent.com/RyukillerZ/MultiportFallback/main/ACCESS/access | grep $MYIP | awk '{print $4}')
...
echo -e "\e[36m╘════════════════════════════════════════════╛\033[0m"
echo -e "       \033[1;37mMULTIPORT FALLBACK BY RyukillerZ\033[0m"
echo -e "\e[36m╒════════════════════════════════════════════╕\033[0m"
...
echo -e "\e[36m╘════════════════════════════════════════════╛\033[0m
 ...
 [\033[1;36m•16\033[0m]  Backup Data Via Telegram Bot
 [\033[1;36m•17\033[0m]  Backup & Restore
 [\033[1;36m•18\033[0m]  Reboot VPS
"
if [[ $serverV > $myver ]]; then
echo -e " [\033[1;36m•19\033[0m]  Update Autoscript To V$serverV\n"
up2u="updatews"
else
up2u="menu"
fi
