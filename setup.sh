#!/bin/bash
# =========================================
# Multiport Fallback By RyukillerZ
# Version    : V1.0 Multiport Fallback
# Script By  : RyukillerZ
# (C) Copyright 2022 By RyukillerZ
# =========================================
clear
#Color
RED="\033[31m"
...
wget -O /usr/local/bin/xray "https://raw.githubusercontent.com/RyukillerZ/xray-core-1.7.5/main/xray"
...
# set login banner
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/RyukillerZ/MultiportFallback/main/OTHERS/issues.net" && chmod +x /etc/issue.net
...
Documentation=https://t.me/RyukillerZ https://github.com/XTLS/Xray-core
...
#Nginx Webserver
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/RyukillerZ/MultiportFallback/main/OTHERS/vps.conf"
...
wget -O /usr/bin/nf "https://raw.githubusercontent.com/RyukillerZ/MediaUnlockerTest/main/media.sh" && chmod +x /usr/bin/nf
